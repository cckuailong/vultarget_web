<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="vul_name" width="300" :show-overflow-tooltip=true label="漏洞名称"></el-table-column>
      ...
      <el-table-column prop="combination_desc" label="操作" :show-overflow-tooltip=true>
        <template slot-scope="{row}">
          ...
          <el-button size="mini" type="primary" icon="el-icon-caret-right" v-if="row.container_status === 'running' || row.container_status === 'stop'"
                     @click="redirWP(row)" >复现</el-button>
        </template>
      </el-table-column>
    </el-table>
